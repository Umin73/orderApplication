...
import KioskMyInfo from "./orderApp/etcTab/KioskMyInfo";
import KioskMyInfoPage from "./orderApp/etcTab/KioskMyInfoPage";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/kiosk/my-info" element={<KioskMyInfoPage />} />
